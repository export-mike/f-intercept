...
var _efetch = require('@mikeljames/efetch');

var _efetch2 = _interopRequireDefault(_efetch);
...
var f = function f(base, path, options) {
  return (0, _efetch2.default)(_url2.default.resolve(base, path), options).then((0, _curry2.default)(intercept)(base, path, options));
};
